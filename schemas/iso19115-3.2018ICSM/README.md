...
Validation steps are first XSD validation made on the schema, then the schematron validation defined in folder  [iso19115-3.2018ICSM/schematron](https://github.com/geonetwork/core-geonetwork/tree/master/schemas/iso19115-3.2018ICSM/src/main/plugin/iso19115-3.2018ICSM/schematron). 2 famillies of rules are available:
...
To retrieve the record in ISO19115-3.2018ICSM, use http://standards.iso.org/iso/19115/-3/mdb/2.0 output schema.
```xml
<?xml version="1.0"?>
