 ...
 */
package org.fao.geonet.schema.iso19115_3_2018ICSM;
...
import static org.fao.geonet.schema.iso19115_3_2018ICSM.ISO19115_3_2018ICSMNamespaces.XLINK;


public class ISO19115_3_2018ICSMSchemaPlugin
    ...
    static {
        allNamespaces = ImmutableSet.<Namespace>builder()
            .add(ISO19115_3_2018ICSMNamespaces.GCO)
            .add(ISO19115_3_2018ICSMNamespaces.MDB)
            .add(ISO19115_3_2018ICSMNamespaces.GEX)
            .add(ISO19115_3_2018ICSMNamespaces.MRC)
            .add(ISO19115_3_2018ICSMNamespaces.MRL)
            .add(ISO19115_3_2018ICSMNamespaces.LAN)
            .add(ISO19115_3_2018ICSMNamespaces.MRI)
            .add(ISO19115_3_2018ICSMNamespaces.CIT)
            .add(ISO19115_3_2018ICSMNamespaces.SRV)
            .add(XLINK)
            .build();
    ...
    public ISO19115_3_2018ICSMSchemaPlugin() {
    ...
    private AssociatedResource metadataRefAsAssociatedResource(Element sibling) {
        Element ref = sibling.getChild("metadataReference", ISO19115_3_2018ICSMNamespaces.MRI);
        String sibUuid = ref.getAttributeValue("uuidref");

        String associationType = sibling.getChild("associationType", ISO19115_3_2018ICSMNamespaces.MRI)
            .getChild("DS_AssociationTypeCode", ISO19115_3_2018ICSMNamespaces.MRI)
            .getAttributeValue("codeListValue");

        String initType = "";
        final Element initiativeTypeEl = sibling.getChild("initiativeType", ISO19115_3_2018ICSMNamespaces.MRI);
        if (initiativeTypeEl != null) {
            initType = initiativeTypeEl.getChild("DS_InitiativeTypeCode", ISO19115_3_2018ICSMNamespaces.MRI)
                .getAttributeValue("codeListValue");
        }
    ...
    public void addTranslationToElement(Element element, String languageIdentifier, String value) {
        ...
        Element langElem = new Element("LocalisedCharacterString", ISO19115_3_2018ICSMNamespaces.LAN);
        langElem.setAttribute("locale", "#" + languageIdentifier);
        langElem.setText(value);
        Element textGroupElement = new Element("textGroup", ISO19115_3_2018ICSMNamespaces.LAN);
        textGroupElement.addContent(langElem);

        // Get the PT_FreeText node where to insert the translation into
        Element freeTextElement = element.getChild("PT_FreeText", ISO19115_3_2018ICSMNamespaces.LAN);
        if (freeTextElement == null) {
            freeTextElement = new Element("PT_FreeText", ISO19115_3_2018ICSMNamespaces.LAN);
    ...
    public Element removeTranslationFromElement(Element element, List<String> langs) throws JDOMException {
        ...
        List<Element> nodesWithStrings = (List<Element>) Xml.selectNodes(element, "*//lan:PT_FreeText", Arrays.asList(ISO19115_3_2018ICSMNamespaces.LAN));

        for (Element e : nodesWithStrings) {
            // Retrieve or create the main language element
            Element mainCharacterString = ((Element) e.getParent()).getChild("CharacterString", ISO19115_3_2018ICSMNamespaces.GCO);
            if (mainCharacterString == null) {
                // create it if it does not exist
                mainCharacterString = new Element("CharacterString", ISO19115_3_2018ICSMNamespaces.GCO);
            ...
            List<Element> mainLangElement = (List<Element>) Xml.selectNodes(
                ...
                Arrays.asList(ISO19115_3_2018ICSMNamespaces.LAN));
            ...
            if (mainLangElement.size() == 1) {
                ...
                } else if (mainCharacterString.getAttribute("nilReason", ISO19115_3_2018ICSMNamespaces.GCO) == null) {
                    ((Element) mainCharacterString.getParent()).setAttribute("nilReason", "missing", ISO19115_3_2018ICSMNamespaces.GCO);
                }
    ...
    public Element createBasicTypeCharacterString() {
        return new Element("CharacterString", ISO19115_3_2018ICSMNamespaces.GCO);
    ...
    public Element addOperatesOn(Element serviceRecord,
        ...
        Element root = serviceRecord
            .getChild("identificationInfo", ISO19115_3_2018ICSMNamespaces.MDB)
            .getChild("SV_ServiceIdentification", ISO19115_3_2018ICSMNamespaces.SRV);

        if (root != null) {

            // Coupling type MUST be present as it is the insertion point
            // for coupledResource
            Element couplingType = root.getChild("couplingType", ISO19115_3_2018ICSMNamespaces.SRV);
            ...
            layers.keySet().forEach(uuid -> {
                ...
                Element coupledResource = new Element("coupledResource", ISO19115_3_2018ICSMNamespaces.SRV);
                coupledResource.setAttribute("nilReason", "synchronizedFromOGC", ISO19115_3_2018ICSMNamespaces.GCO);
                Element scr = new Element("SV_CoupledResource", ISO19115_3_2018ICSMNamespaces.SRV);


                // Create operation according to service type
                Element operation = new Element("operation", ISO19115_3_2018ICSMNamespaces.SRV);
                Element operationMetadata = new Element("SV_OperationMetadata", ISO19115_3_2018ICSMNamespaces.SRV);
                Element operationName = new Element("operationName", ISO19115_3_2018ICSMNamespaces.SRV);
                Element operationValue = new Element("CharacterString", ISO19115_3_2018ICSMNamespaces.GCO);
                ...
                Element id = new Element("resourceReference", ISO19115_3_2018ICSMNamespaces.SRV);
                ...
                Element scopedName = new Element("scopedName", ISO19115_3_2018ICSMNamespaces.SRV);
                Element scopedNameValue = new Element("ScopedName", ISO19115_3_2018ICSMNamespaces.GCO);
...
//                scr.addContent(operation);
                ...
                Element op = new Element("operatesOn", ISO19115_3_2018ICSMNamespaces.SRV);
                op.setAttribute("nilReason", "synchronizedFromOGC", ISO19115_3_2018ICSMNamespaces.GCO);
    ...
    public List<Extent> getExtents(Element metadataRecord) {
        ...
        ElementFilter bboxFinder = new ElementFilter("EX_GeographicBoundingBox", ISO19115_3_2018ICSMNamespaces.GEX);
        @SuppressWarnings("unchecked")
        ...
        while (bboxes.hasNext()) {
            ...
            try {
                extents.add(new Extent(
                    Double.valueOf(box.getChild("westBoundLongitude", ISO19115_3_2018ICSMNamespaces.GEX).getChild("Decimal", ISO19115_3_2018ICSMNamespaces.GCO).getText()),
                    Double.valueOf(box.getChild("eastBoundLongitude", ISO19115_3_2018ICSMNamespaces.GEX).getChild("Decimal", ISO19115_3_2018ICSMNamespaces.GCO).getText()),
                    Double.valueOf(box.getChild("southBoundLatitude", ISO19115_3_2018ICSMNamespaces.GEX).getChild("Decimal", ISO19115_3_2018ICSMNamespaces.GCO).getText()),
                    Double.valueOf(box.getChild("northBoundLatitude", ISO19115_3_2018ICSMNamespaces.GEX).getChild("Decimal", ISO19115_3_2018ICSMNamespaces.GCO).getText())
                ));
        ...
        if (elementToProcess && parsedAttributeName.equals("xlink:href")) {
            ...
            if (isMultilingualElement) {
                ...
                Element targetElement = el.getParentElement().getParentElement().getParentElement()
                    .getChild("CharacterString", ISO19115_3_2018ICSMNamespaces.GCO);
            ...
            if (isEmptyLink) {
                el.setNamespace(ISO19115_3_2018ICSMNamespaces.GCO).setName("CharacterString");
                el.removeAttribute("href", XLINK);
                return el;
            } else {
                el.setNamespace(ISO19115_3_2018ICSMNamespaces.GCX).setName("Anchor");
    ...
    public <L, M> RawLinkPatternStreamer<L, M> createLinkStreamer(ILinkBuilder<L, M> linkbuilder, String excludePattern) {
        ...
        patternStreamer.setNamespaces(ISO19115_3_2018ICSMSchemaPlugin.allNamespaces.asList());
        // TODO: Add xlink:href ?
