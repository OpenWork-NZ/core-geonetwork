...
<xsl:stylesheet version="2.0"
  ...
  <xd:doc xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" scope="stylesheet">
    <xd:desc>
      <xd:p>
        <xd:b>Created on:</xd:b>December 5, 2014
      </xd:p>
      <xd:p>These templates transform ISO 19139 CI_Responsibility XML content into ISO 19115-3 CI_Responsibility They
        are designed to be imported as a template library
      </xd:p>
      <xd:p>
  ...
  <xsl:template match="gmd:CI_ResponsibleParty" mode="from19139to19115-3.2018ICSM">
    <xsl:choose>
      <xsl:when
        test="count(gmd:individualName/gcoold:CharacterString) + count(gmd:organisationName/gcoold:CharacterString) + count(gmd:positionName/gcoold:CharacterString) > 0">
        <!--
        ...
        <xsl:element name="cit:CI_Responsibility">
          ...
          <xsl:choose>
            ...
            <xsl:when test="./gmd:role/@*">
              <cit:role>
                <xsl:apply-templates select="./gmd:role/@*" mode="from19139to19115-3.2018ICSM"/>
              </cit:role>
            </xsl:when>
            <xsl:otherwise>
...
-->
    <xsl:apply-templates select=".//gmd:onlineResource" mode="from19139to19115-3.2018ICSM"/>
  </xsl:template>

  <xsl:template match="gmd:contactInfo/gmd:CI_Contact/gmd:phone" mode="from19139to19115-3.2018ICSM">
  ...
  <xsl:template match="gmd:CI_ResponsibleParty/gmd:role" priority="5" mode="from19139to19115-3.2018ICSM"/>
  <xsl:template match="gmd:CI_ResponsibleParty/gmd:organisationName" priority="5" mode="from19139to19115-3.2018ICSM"/>
  <xsl:template match="gmd:CI_ResponsibleParty/gmd:individualName" priority="5" mode="from19139to19115-3.2018ICSM"/>
  <xsl:template match="gmd:CI_ResponsibleParty/gmd:positionName" priority="5" mode="from19139to19115-3.2018ICSM"/>
