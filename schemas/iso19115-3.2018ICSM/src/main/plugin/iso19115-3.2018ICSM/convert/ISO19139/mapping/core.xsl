<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                xmlns:gml30="http://www.opengis.net/gml" xmlns:cat="http://standards.iso.org/iso/19115/-3/cat/1.0"
  ...
  -->
  <xsl:template match="gmd:fileIdentifier" priority="5" mode="from19139to19115-3.2018ICSM">
    <!--
    ...
    <xsl:element name="mdb:metadataIdentifier">
      <xsl:apply-templates select="@*" mode="from19139to19115-3.2018ICSM"/>
      <mcc:MD_Identifier>
        <xsl:for-each select="*">
          <mcc:code>
  ...
  <xsl:template match="gfcold:FC_FeatureCatalogue/@uuid" priority="5" mode="from19139to19115-3.2018ICSM">
    <xsl:element name="mdb:metadataIdentifier">
      <mcc:MD_Identifier>
        <mcc:code>
          <gco:CharacterString>
  ...
  <xsl:template match="gfcold:typeName/gcoold:LocalName
                ...
                mode="from19139to19115-3.2018ICSM">
    <xsl:value-of select="."/>
  </xsl:template>


  <xsl:template match="gmd:language|gmd:locale" priority="5" mode="from19139to19115-3.2018ICSM">
    <xsl:variable name="nameSpacePrefix">
      <xsl:call-template name="getNamespacePrefix"/>
    </xsl:variable>
  ...
  <xsl:template match="gmd:characterSet" priority="5" mode="from19139to19115-3.2018ICSM">
    <xsl:choose>
  ...
  <xsl:template match="gmd:parentIdentifier" priority="5" mode="from19139to19115-3.2018ICSM">
    <!--
  ...
  <xsl:template match="gmd:hierarchyLevel" priority="5" mode="from19139to19115-3.2018ICSM">
    <!-- ************************************************************************ -->
  ...
  <xsl:template match="gmd:dateStamp" priority="5" mode="from19139to19115-3.2018ICSM">
    <!--
  ...
  <xsl:template match="gmi:geographicCoordinates" mode="from19139to19115-3.2018ICSM">
    <xsl:choose>
  ...
  <xsl:template match="gmd:MD_PixelOrientationCode" mode="from19139to19115-3.2018ICSM">
  ...
  <xsl:template match="gmd:identificationInfo" mode="from19139to19115-3.2018ICSM">
    <mdb:identificationInfo>
      ...
      <xsl:for-each select="./*">
        ...
        <xsl:element name="{concat($nameSpacePrefix,':',local-name(.))}">
          <xsl:apply-templates select="@*" mode="from19139to19115-3.2018ICSM"/>
          <xsl:apply-templates select="gmd:citation" mode="from19139to19115-3.2018ICSM"/>
          <xsl:call-template name="writeCharacterStringElement">
          ...
          <xsl:apply-templates select="gmd:credit" mode="from19139to19115-3.2018ICSM"/>
          <xsl:call-template name="writeCodelistElement">
          ...
          <xsl:apply-templates select="gmd:pointOfContact" mode="from19139to19115-3.2018ICSM"/>
          <xsl:call-template name="writeCodelistElement">
          ...
          <xsl:apply-templates select="gmd:spatialResolution" mode="from19139to19115-3.2018ICSM"/>
          <!-- This is here to handle early adopters of temporalResolution -->
          <xsl:apply-templates select="gmd:temporalResolution" mode="from19139to19115-3.2018ICSM"/>
          <xsl:apply-templates select="gmd:topicCategory" mode="from19139to19115-3.2018ICSM"/>
          <xsl:apply-templates select="gmd:extent | srvold:extent" mode="from19139to19115-3.2018ICSM"/>
          <xsl:apply-templates select="gmd:resourceMaintenance" mode="from19139to19115-3.2018ICSM"/>
          <xsl:apply-templates select="gmd:graphicOverview" mode="from19139to19115-3.2018ICSM"/>
          <xsl:apply-templates select="gmd:resourceFormat" mode="from19139to19115-3.2018ICSM"/>
          <xsl:apply-templates select="gmd:descriptiveKeywords" mode="from19139to19115-3.2018ICSM"/>
          <xsl:apply-templates select="gmd:resourceSpecificUsage" mode="from19139to19115-3.2018ICSM"/>
          <xsl:apply-templates select="gmd:resourceConstraints" mode="from19139to19115-3.2018ICSM"/>
          <xsl:apply-templates select="gmd:aggregationInfo" mode="from19139to19115-3.2018ICSM"/>
          <xsl:call-template name="collectiveTitle"/>
          <xsl:apply-templates select="gmd:language" mode="from19139to19115-3.2018ICSM"/>
          <xsl:apply-templates select="gmd:characterSet" mode="from19139to19115-3.2018ICSM"/>
          <xsl:call-template name="writeCharacterStringElement">
          ...
          <xsl:if test="local-name()='SV_ServiceIdentification'">
            ...
            <xsl:apply-templates select="srvold:containsOperations" mode="from19139to19115-3.2018ICSM"/>
            <xsl:apply-templates select="srvold:operatesOn" mode="from19139to19115-3.2018ICSM"/>
          </xsl:if>
        </xsl:element>
      </xsl:for-each>
    </mdb:identificationInfo>
  ...
  <xsl:template match="gmd:contentInfo[not(gmd:MD_FeatureCatalogueDescription) and
                                           not(gmd:MD_ImageDescription)]" mode="from19139to19115-3.2018ICSM">
            ...
            <xsl:for-each
              ...
              <xsl:element name="mrc:attributeGroup">
                <xsl:element name="mrc:MD_AttributeGroup">
                  <xsl:apply-templates mode="from19139to19115-3.2018ICSM"/>
                </xsl:element>
              </xsl:element>
            </xsl:for-each>
  ...
  <xsl:template match="//gmd:MD_FeatureCatalogueDescription/gmd:featureTypes" mode="from19139to19115-3.2018ICSM">
    <mrc:featureTypes>
  ...
  <xsl:template match="gmi:acquisitionInformation" mode="from19139to19115-3.2018ICSM">
    <xsl:element name="mdb:acquisitionInformation">
      <xsl:element name="mac:MI_AcquisitionInformation">
        <xsl:apply-templates select="gmi:MI_AcquisitionInformation/gmi:instrument" mode="from19139to19115-3.2018ICSM"/>
        <xsl:apply-templates select="gmi:MI_AcquisitionInformation/gmi:operation" mode="from19139to19115-3.2018ICSM"/>
        <xsl:apply-templates select="gmi:MI_AcquisitionInformation/gmi:platform" mode="from19139to19115-3.2018ICSM"/>
        <xsl:apply-templates select="gmi:MI_AcquisitionInformation/gmi:acquisitionPlan"
                             mode="from19139to19115-3.2018ICSM"/>
        <xsl:apply-templates select="gmi:MI_AcquisitionInformation/gmi:objective" mode="from19139to19115-3.2018ICSM"/>
        <xsl:apply-templates select="gmi:MI_AcquisitionInformation/gmi:acquisitionRequirement"
                             mode="from19139to19115-3.2018ICSM"/>
      </xsl:element>
    </xsl:element>
  </xsl:template>
  <xsl:template match="gmi:objectiveOccurance" mode="from19139to19115-3.2018ICSM">
  ...
  -->
  <xsl:template match="gmi:geolocationInformation/gmi:MI_GCPCollection" mode="from19139to19115-3.2018ICSM">
    <xsl:element name="msr:MI_GCPCollection">
      <xsl:apply-templates select="gmi:gcp" mode="from19139to19115-3.2018ICSM"/>
      <xsl:apply-templates select="gmi:collectionIdentification" mode="from19139to19115-3.2018ICSM"/>
      <xsl:apply-templates select="gmi:collectionName" mode="from19139to19115-3.2018ICSM"/>
      <xsl:apply-templates select="gmi:coordinateReferenceSystem" mode="from19139to19115-3.2018ICSM"/>
    </xsl:element>
  </xsl:template>
  <!--
  ...
  <xsl:template match="gmd:aggregationInfo" priority="5" mode="from19139to19115-3.2018ICSM">
    <!--
    ...
    <mri:associatedResource>
      <xsl:element name="mri:MD_AssociatedResource">
        ...
        <xsl:call-template name="writeCodelistElement">
          ...
          <xsl:with-param name="codeListValue"
                          select="gmd:MD_AggregateInformation/gmd:associationType/gmd:DS_AssociationTypeCode/@codeListValue"/>
        </xsl:call-template>
        <xsl:call-template name="writeCodelistElement">
          ...
          <xsl:with-param name="codeListValue"
                          select="gmd:MD_AggregateInformation/gmd:initiativeType/gmd:DS_InitiativeTypeCode/@codeListValue"/>
        </xsl:call-template>
        ...
        <xsl:if test="$associatedResourceAsMetadataReferenceOnly">
          ...
          <mri:metadataReference>
            <xsl:copy-of
              select="gmd:MD_AggregateInformation/gmd:aggregateDataSetIdentifier/*/gmd:code/gmx:Anchor/@xlink:href"/>
            <xsl:copy-of
              select="if ($uuidref != '') then $uuidref else gmd:MD_AggregateInformation/gmd:aggregateDataSetIdentifier/*/gmd:code/*/text()"/>
          </mri:metadataReference>
        </xsl:if>
  ...
  -->
  <xsl:template match="gmd:RS_Identifier" mode="from19139to19115-3.2018ICSM">
    <mcc:MD_Identifier>
      <xsl:apply-templates select="@*" mode="from19139to19115-3.2018ICSM"/>
      <xsl:apply-templates mode="from19139to19115-3.2018ICSM"/>
    </mcc:MD_Identifier>
  ...
  <!--
    gmd:contentInfo
  -->
  <xsl:template match="gmd:dimension" mode="from19139to19115-3.2018ICSM">
    <xsl:element name="mrc:attribute">
      <xsl:apply-templates mode="from19139to19115-3.2018ICSM"/>
    </xsl:element>
  </xsl:template>
  <xsl:template match="gmd:MD_Band" mode="from19139to19115-3.2018ICSM">
    <xsl:element name="mrc:MD_SampleDimension">
      <xsl:apply-templates mode="from19139to19115-3.2018ICSM"/>
    </xsl:element>
  </xsl:template>
  <xsl:template match="gmi:MI_Band" mode="from19139to19115-3.2018ICSM">
  ...
  <xsl:template match="gmd:MD_Band/gmd:descriptor|
                       ...
                       gmd:MD_RangeDimension/gmd:descriptor" mode="from19139to19115-3.2018ICSM">
  ...
  -->
  <xsl:template match="gmd:MD_MaintenanceInformation/gmd:dateOfNextUpdate" mode="from19139to19115-3.2018ICSM">
    <mmi:maintenanceDate>
      <cit:CI_Date>
        <cit:date>
          <xsl:call-template name="writeDateTime"/>
  ...
  -->
  <xsl:template match="gmi:MI_Operation/gmi:status/gmd:MD_ProgressCode" mode="from19139to19115-3.2018ICSM">
  ...
  -->
  <xsl:template match="gmd:hierarchyLevelName" priority="5" mode="from19139to19115-3.2018ICSM"/>
  <xsl:template match="gmd:metadataStandardVersion" priority="5" mode="from19139to19115-3.2018ICSM"/>
  <xsl:template match="gmd:dataSetURI" priority="5" mode="from19139to19115-3.2018ICSM"/>
  <!-- Match MD_ and MI_CoverageDescription -->
  <xsl:template
    match="gmd:contentInfo/gmd:MD_CoverageDescription/gmd:attributeDescription | gmd:contentInfo/gmi:MI_CoverageDescription/gmd:attributeDescription"
    priority="5" mode="from19139to19115-3.2018ICSM"/>
  ...
  <xsl:template match="gmd:MD_ExtendedElementInformation/gmd:domainCode" priority="5"
                mode="from19139to19115-3.2018ICSM"/>
  <xsl:template match="gmd:MD_Format/gmd:name" priority="5" mode="from19139to19115-3.2018ICSM"/>
  <xsl:template match="gmd:MD_Format/gmd:specification" priority="5" mode="from19139to19115-3.2018ICSM"/>
  <xsl:template match="gmd:MD_Format/gmd:version" priority="5" mode="from19139to19115-3.2018ICSM"/>
</xsl:stylesheet>
