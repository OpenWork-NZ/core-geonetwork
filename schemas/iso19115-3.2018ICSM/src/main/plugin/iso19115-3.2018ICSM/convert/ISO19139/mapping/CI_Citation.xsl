<xsl:stylesheet version="2.0"
  ...
  <xd:doc xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" scope="stylesheet">
    <xd:desc>
      ...
      <xd:p>These templates transform ISO 19139 CI_Citation XML content into ISO 19115-3 CI_Citation. They are designed
        to be imported as a template library
      </xd:p>
  ...
  <xsl:template match="gmd:CI_Citation" mode="from19139to19115-3.2018ICSM">
  ...
  <xsl:template match="gmd:CI_Citation/gmd:date" mode="from19139to19115-3.2018ICSM">
    <cit:date>
  ...
  <xsl:template match="gmd:CI_Citation/gmd:title" mode="from19139to19115-3.2018ICSM">
  ...
  <xsl:template match="gmd:CI_Citation/gmd:editionDate" mode="from19139to19115-3.2018ICSM">
    <cit:editionDate>
      <xsl:call-template name="writeDateTime"/>
    </cit:editionDate>
  </xsl:template>
  ...
  <xsl:template match="gmd:CI_Citation/gmd:collectiveTitle" mode="from19139to19115-3.2018ICSM"/>
</xsl:stylesheet>
