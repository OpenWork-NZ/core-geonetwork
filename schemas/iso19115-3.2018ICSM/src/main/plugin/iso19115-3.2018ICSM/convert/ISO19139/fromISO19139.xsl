  ...
  <xd:doc xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" scope="stylesheet">
    <xd:desc>
      ...
      <xd:p>
        ...
        <xd:ul>
          <xd:li>Add multilingual metadata support by converting gmd:locale and copying gmd:PT_FreeText and element
            attributes (eg. gco:nilReason, xsi:type) for gmd:CharacterString elements (Author:
            fx.prunayre@gmail.com).
          </xd:li>
        </xd:ul>
      </xd:p>
      <xd:p>
  ...
  <xsl:template match="/">
    ...
    <xsl:for-each select="//(gmd:MD_Metadata|gmi:MI_Metadata|gfcold:FC_FeatureCatalogue)">
      ...
      <xsl:element name="mdb:MD_Metadata">
        <!-- new namespaces -->
        <xsl:call-template name="add-iso19115-3.2018ICSM-namespaces"/>

        <xsl:apply-templates select="gmd:fileIdentifier|@uuid" mode="from19139to19115-3.2018ICSM"/>
        ...
        <xsl:apply-templates select="gmd:parentIdentifier" mode="from19139to19115-3.2018ICSM"/>
        <xsl:apply-templates select="gmd:hierarchyLevel" mode="from19139to19115-3.2018ICSM"/>
        <xsl:apply-templates select="gmd:contact" mode="from19139to19115-3.2018ICSM"/>
            ...
            <lan:PT_Locale id="EN">
              <lan:language>
                <lan:LanguageCode codeList="http://www.loc.gov/standards/iso639-2/"
                                  codeListValue="{gfcold:functionalLanguage/*/text()}"/>
              </lan:language>
        ...
        <xsl:apply-templates select="gmd:dateStamp" mode="from19139to19115-3.2018ICSM"/>
        <xsl:apply-templates select="gmd:metadataStandardName" mode="from19139to19115-3.2018ICSM"/>
        ...
        <xsl:apply-templates select="gmd:locale" mode="from19139to19115-3.2018ICSM"/>
        <xsl:apply-templates select="gmd:spatialRepresentationInfo" mode="from19139to19115-3.2018ICSM"/>
        <xsl:apply-templates select="gmd:referenceSystemInfo" mode="from19139to19115-3.2018ICSM"/>
        <xsl:apply-templates select="gmd:metadataExtensionInfo" mode="from19139to19115-3.2018ICSM"/>
        <xsl:apply-templates select="gmd:identificationInfo" mode="from19139to19115-3.2018ICSM"/>
        <xsl:apply-templates select="gmd:contentInfo" mode="from19139to19115-3.2018ICSM"/>
        ...
        <xsl:apply-templates select="gmd:distributionInfo" mode="from19139to19115-3.2018ICSM"/>
        <xsl:apply-templates select="gmd:dataQualityInfo" mode="from19139to19115-3.2018ICSM"/>
        <xsl:apply-templates select="gmd:portrayalCatalogueInfo" mode="from19139to19115-3.2018ICSM"/>
        <xsl:call-template name="onlineSourceDispatcher">
          <xsl:with-param name="type" select="'portrayalCatalogueCitation'"/>
        </xsl:call-template>

        <xsl:apply-templates select="gmd:metadataConstraints" mode="from19139to19115-3.2018ICSM"/>
        <xsl:apply-templates select="gmd:applicationSchemaInfo" mode="from19139to19115-3.2018ICSM"/>
        <xsl:apply-templates select="gmd:metadataMaintenance" mode="from19139to19115-3.2018ICSM"/>
        <xsl:apply-templates select="gmi:acquisitionInformation" mode="from19139to19115-3.2018ICSM"/>
      </xsl:element>
    </xsl:for-each>
  </xsl:template>
