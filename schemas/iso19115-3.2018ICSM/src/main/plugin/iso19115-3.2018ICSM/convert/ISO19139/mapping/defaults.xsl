<xsl:stylesheet version="2.0"
  ...
  <xsl:template match="gml30:*|gml:*" mode="from19139to19115-3.2018ICSM">
  ...
  <xsl:template match="@gcoold:*" mode="from19139to19115-3.2018ICSM">
    <xsl:attribute name="gco:{local-name()}">
      <xsl:value-of select="."/>
    </xsl:attribute>
  </xsl:template>

  <xsl:template match="@*" mode="from19139to19115-3.2018ICSM">
    <xsl:copy-of select="."/>
  </xsl:template>
  ...
  <xsl:template match="gmd:CI_OnlineResource/gmd:linkage/gmd:URL" mode="from19139to19115-3.2018ICSM">
    <gco:CharacterString>
      <xsl:value-of select="."/>
    </gco:CharacterString>
  </xsl:template>

  <xsl:template match="gmd:MD_Format" mode="from19139to19115-3.2018ICSM">
