<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="gmd:dataQualityInfo" mode="from19139to19115-3.2018ICSM">
              ...
              <xsl:element name="mdq:report">
                ...
                <xsl:element name="{concat('mdq:',$dataQualityReportType)}">
                  <xsl:if test="gmd:nameOfMeasure or gmd:measureIdentification or gmd:measureDescription">
                    ...
                    <mdq:measure>
                      <mdq:DQ_MeasureReference>
                        <xsl:apply-templates select="gmd:measureIdentification" mode="from19139to19115-3.2018ICSM"/>
                  ...
                  <xsl:if
                    ...
                    <xsl:apply-templates select="gmd:result" mode="from19139to19115-3.2018ICSM"/>
                  </xsl:if>
    ...
    <xsl:for-each select="gmd:DQ_DataQuality/gmd:lineage/gmd:LI_Lineage">
      ...
      <xsl:element name="mdb:resourceLineage">
        <mrl:LI_Lineage>
          ...
          <xsl:apply-templates select="gmd:source" mode="from19139to19115-3.2018ICSM"/>
          <xsl:apply-templates select="gmd:processStep" mode="from19139to19115-3.2018ICSM"/>
        </mrl:LI_Lineage>
      </xsl:element>
    </xsl:for-each>
  </xsl:template>

  <xsl:template match="gmd:report/*/gmd:result/gmd:DQ_QuantitativeResult" mode="from19139to19115-3.2018ICSM">
    <mdq:DQ_QuantitativeResult>
      <xsl:apply-templates select="gmd:value" mode="from19139to19115-3.2018ICSM"/>
      <xsl:apply-templates select="gmd:valueUnit" mode="from19139to19115-3.2018ICSM"/>
      <xsl:apply-templates select="gmd:valueType" mode="from19139to19115-3.2018ICSM"/>
    </mdq:DQ_QuantitativeResult>
  </xsl:template>

  <!-- added to account for element name change from valueType to valueRecordType - 2014-07-29 -->
  <xsl:template match="gmd:result/gmd:DQ_QuantitativeResult/gmd:valueType" mode="from19139to19115-3.2018ICSM">
  ...
  <xsl:template match="gmd:LI_ProcessStep/gmd:source" mode="from19139to19115-3.2018ICSM">
    <mrl:source>
      <xsl:apply-templates select="@*" mode="from19139to19115-3.2018ICSM"/>
      <xsl:if test="*[1]">
        ...
        <xsl:element name="{$lineageElement}">
          ...
          <xsl:apply-templates select="./*/gmd:scaleDenominator" mode="from19139to19115-3.2018ICSM"/>
          <xsl:apply-templates select="./*/gmd:sourceReferenceSystem" mode="from19139to19115-3.2018ICSM"/>
          <xsl:apply-templates select="./*/gmd:sourceCitation" mode="from19139to19115-3.2018ICSM"/>
          <xsl:apply-templates select="./*/gmd:sourceExtent" mode="from19139to19115-3.2018ICSM"/>
          <xsl:apply-templates select="./*/gmd:sourceStep" mode="from19139to19115-3.2018ICSM"/>
          <xsl:apply-templates select="./*/gmi:processedLevel" mode="from19139to19115-3.2018ICSM"/>
          <xsl:apply-templates select="./*/gmi:resolution" mode="from19139to19115-3.2018ICSM"/>
        </xsl:element>
      </xsl:if>
    </mrl:source>
  </xsl:template>
  ...
  <xsl:template match="gmi:LE_ProcessStep" mode="from19139to19115-3.2018ICSM">
    <xsl:element name="mrl:LE_ProcessStep">
      <xsl:apply-templates select="@*" mode="from19139to19115-3.2018ICSM"/>
      <xsl:apply-templates select="gmd:description" mode="from19139to19115-3.2018ICSM"/>
      <xsl:apply-templates select="gmd:dateTime" mode="from19139to19115-3.2018ICSM"/>
      <xsl:apply-templates select="gmd:processor" mode="from19139to19115-3.2018ICSM"/>
      <xsl:apply-templates select="gmd:source" mode="from19139to19115-3.2018ICSM"/>
      <xsl:apply-templates select="gmi:processingInformation" mode="from19139to19115-3.2018ICSM"/>
      <xsl:apply-templates select="gmi:report" mode="from19139to19115-3.2018ICSM"/>
      <xsl:apply-templates select="gmi:output" mode="from19139to19115-3.2018ICSM"/>
    </xsl:element>
  </xsl:template>

  <xsl:template match="gmd:LI_ProcessStep/gmd:dateTime | gmi:LE_ProcessStep/gmd:dateTime"
                mode="from19139to19115-3.2018ICSM" priority="5">
    <mrl:stepDateTime>
      <gml:TimeInstant>
  ...
  <xsl:template match="gmi:LE_Processing" mode="from19139to19115-3.2018ICSM">
    <xsl:element name="mrl:LE_Processing">
      <xsl:apply-templates select="@*" mode="from19139to19115-3.2018ICSM"/>
      <xsl:apply-templates select="gmi:algorithm" mode="from19139to19115-3.2018ICSM"/>
      <xsl:apply-templates select="gmi:identifier" mode="from19139to19115-3.2018ICSM"/>
      <xsl:apply-templates select="gmi:softwareReference" mode="from19139to19115-3.2018ICSM"/>
      <xsl:apply-templates select="gmi:procedureDescription" mode="from19139to19115-3.2018ICSM"/>
      <xsl:apply-templates select="gmi:documentation" mode="from19139to19115-3.2018ICSM"/>
      <xsl:apply-templates select="gmi:runTimeParameters" mode="from19139to19115-3.2018ICSM"/>
    </xsl:element>
  </xsl:template>
