<xsl:stylesheet version="2.0"
  ...
  <xsl:template match="srvold:optionality" mode="from19139to19115-3.2018ICSM">
    <srv:optionality>
      <gco:Boolean>
  ...
  <xsl:template match="srvold:containsOperations" mode="from19139to19115-3.2018ICSM">
    <srv:containsOperations>
      <srv:SV_OperationMetadata>
        ...
        <xsl:apply-templates select="srvold:SV_OperationMetadata/srvold:parameters" mode="from19139to19115-3.2018ICSM"/>
      </srv:SV_OperationMetadata>
    </srv:containsOperations>
  </xsl:template>

  <xsl:template match="srvold:parameters" mode="from19139to19115-3.2018ICSM">
    <srv:parameter>
      <xsl:apply-templates select="srvold:SV_Parameter" mode="from19139to19115-3.2018ICSM"/>
    </srv:parameter>
  </xsl:template>

  <xsl:template match="srvold:SV_Parameter/srvold:name" mode="from19139to19115-3.2018ICSM">
