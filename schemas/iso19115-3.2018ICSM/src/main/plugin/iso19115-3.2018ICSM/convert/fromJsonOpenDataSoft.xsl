    ...
    <mdb:MD_Metadata xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
      ...
      <mdb:dateInfo>
        <cit:CI_Date>
          <cit:date>
            <gco:DateTime>
              <xsl:value-of select="(metas/modified|dataset/metas/default/metadata_processed)[1]"/>
            </gco:DateTime>
          </cit:date>
          <cit:dateType>
      ...
      <mdb:dateInfo>
        <cit:CI_Date>
          <cit:date>
            <gco:DateTime>
              <xsl:value-of select="metas/metadata_processed"/>
            </gco:DateTime>
          </cit:date>
          <cit:dateType>
        ...
        <mri:MD_DataIdentification>
            ...
            <cit:CI_Citation>
              ...
              <cit:date>
                <cit:CI_Date>
                  <cit:date>
                    <gco:DateTime>
                      <xsl:value-of select="metas/data_processed"/>
                    </gco:DateTime>
                  </cit:date>
                  <cit:dateType>
                    <cit:CI_DateTypeCode codeList="codeListLocation#CI_DateTypeCode" codeListValue="revision"/>
          ...
          <mri:defaultLocale>
            <lan:PT_Locale>
              <lan:language>
                <lan:LanguageCode codeList="codeListLocation#LanguageCode"
                                  codeListValue="{java-xsl-util:threeCharLangCode((metas/language|dataset/meta/default/language)[1])}"/>
              </lan:language>
              <lan:characterEncoding>
                <lan:MD_CharacterSetCode codeList="codeListLocation#MD_CharacterSetCode"
                                         codeListValue="utf8"/>
