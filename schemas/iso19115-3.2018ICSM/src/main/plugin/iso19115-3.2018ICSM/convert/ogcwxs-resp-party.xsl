      ...
      ows11:ServiceContact/ows11:ContactInfo/ows11:Phone/ows11:Facsimile|
                  ...
                  <xsl:for-each select="$phone">
                    ...
                    <cit:numberType>
                      <cit:CI_TelephoneTypeCode
                        codeList="http://standards.iso.org/iso/19139/resources/gmxCodelists.xml#CI_TelephoneTypeCode"
                        codeListValue="voice"/>
                    </cit:numberType>
                  </xsl:for-each>
            ...
            <cit:address>
              <cit:CI_Address>
                ...
                <xsl:for-each
                  select="(Address|wms:Address|ows:DeliveryPoint|ows11:DeliveryPoint|ows2:DeliveryPoint)[. != '']">
                  <cit:deliveryPoint>
                    <gco:CharacterString>
                      <xsl:value-of select="."/>
                    </gco:CharacterString>
                ...
                <xsl:for-each
                  select="(Country|wms:Country|wcs:address/wcs:country|ows:Country|ows11:Country|ows2:Country)[. != '']">
                  <cit:country>
                    <gco:CharacterString>
                      <xsl:value-of select="."/>
                    </gco:CharacterString>
