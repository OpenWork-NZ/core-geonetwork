                      ...
                      <cit:onlineResource>
                        <cit:CI_OnlineResource>
                          <cit:linkage>
                            <gco:CharacterString>
                              <xsl:value-of
                                select="$license/url"/> <!-- TODO: map codes to actual licenses; use https://www.data.gouv.fr/api/1/datasets/licenses/ -->
                            </gco:CharacterString>
                          </cit:linkage>
                        </cit:CI_OnlineResource>
                      </cit:onlineResource>
          ...
          <mrd:transferOptions>
            <xsl:for-each select="resources">
              <mrd:MD_DigitalTransferOptions>
                ...
                <xsl:variable name="protocolMatch"
                              select="$format-protocol-mapping/entry[format=lower-case($format)]/protocol"></xsl:variable>
                <mrd:transferSize>
                  <gco:Real>
