...
<xsl:stylesheet
  ...
  xmlns:gn-fn-iso19115-3.2018ICSM="http://geonetwork-opensource.org/xsl/functions/profiles/iso19115-3.2018ICSM"
                ...
                <xsl:choose>
                  <xsl:when test="position() = 1">
                    <mrd:transferOptions>
                      <mrd:MD_DigitalTransferOptions>
                        <xsl:apply-templates
                          select="mrd:MD_Distribution/mrd:transferOptions[1]/mrd:MD_DigitalTransferOptions/mrd:unitsOfDistribution"/>
                        <xsl:apply-templates
                          select="mrd:MD_Distribution/mrd:transferOptions[1]/mrd:MD_DigitalTransferOptions/mrd:transferSize"/>
                        <xsl:apply-templates
                          select="mrd:MD_Distribution/mrd:transferOptions[1]/mrd:MD_DigitalTransferOptions/mrd:onLine"/>
                        ...
                        <xsl:apply-templates
                          select="mrd:MD_Distribution/mrd:transferOptions[1]/mrd:MD_DigitalTransferOptions/mrd:offLine"/>
                        <xsl:apply-templates
                          select="mrd:MD_Distribution/mrd:transferOptions[1]/mrd:MD_DigitalTransferOptions/mrd:transferFrequency"/>
                        <xsl:apply-templates
                          select="mrd:MD_Distribution/mrd:transferOptions[1]/mrd:MD_DigitalTransferOptions/mrd:distributionFormat"/>
                      </mrd:MD_DigitalTransferOptions>
                    </mrd:transferOptions>
          ...
          <xsl:for-each select="tokenize($name, ',')">
            <mrd:onLine>
              <cit:CI_OnlineResource>
                <cit:linkage>
                  <xsl:copy-of
                    select="gn-fn-iso19115-3.2018ICSM:fillTextElement($url, '\|', '', $mainLangId, $useOnlyPTFreeText)"/>
                </cit:linkage>
                ...
                <xsl:if test="normalize-space(.) != ''">
                  <cit:name>
                    <xsl:copy-of
                      select="gn-fn-iso19115-3.2018ICSM:fillTextElement(., $mainLangId, $useOnlyPTFreeText)"/>
                  </cit:name>
                </xsl:if>
                ...
                <xsl:if test="$description != ''">
                  <cit:description>
                    <xsl:copy-of
                      select="gn-fn-iso19115-3.2018ICSM:fillTextElement($description, $mainLangId, $useOnlyPTFreeText)"/>
                  </cit:description>
                </xsl:if>
          ...
          <mrd:onLine>
            <cit:CI_OnlineResource>
              ...
              <xsl:if test="normalize-space($name) != ''">
                <cit:name>
                  <xsl:copy-of
                    select="gn-fn-iso19115-3.2018ICSM:fillTextElement($name, $mainLangId, $useOnlyPTFreeText)"/>
                </cit:name>
              </xsl:if>
              ...
              <xsl:if test="$desc != ''">
                <cit:description>
                  <xsl:copy-of
                    select="gn-fn-iso19115-3.2018ICSM:fillTextElement($desc, $mainLangId, $useOnlyPTFreeText)"/>
                </cit:description>
              </xsl:if>
