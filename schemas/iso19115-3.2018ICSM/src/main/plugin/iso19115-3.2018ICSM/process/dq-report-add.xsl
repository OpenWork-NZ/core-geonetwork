    ...
    <mdq:standaloneQualityReport>
      <mdq:DQ_StandaloneQualityReportInformation>
        <mdq:reportReference>
          <cit:CI_Citation>
            <cit:title>
              <xsl:copy-of select="gn-fn-iso19115-3.2018ICSM:fillTextElement($name, $mainLangId, $useOnlyPTFreeText)"/>
            </cit:title>
            <cit:onlineResource>
              <cit:CI_OnlineResource>
                <cit:linkage>
        ...
        <xsl:if test="$desc">
          <mdq:abstract>
            <xsl:copy-of select="gn-fn-iso19115-3.2018ICSM:fillTextElement($desc, $mainLangId, $useOnlyPTFreeText)"/>
          </mdq:abstract>
        </xsl:if>
      </mdq:DQ_StandaloneQualityReportInformation>
    </mdq:standaloneQualityReport>
    ...
    <mrl:additionalDocumentation>
      <cit:CI_Citation>
        ...
        <cit:onlineResource>
          <cit:CI_OnlineResource>
            <cit:linkage>
              <xsl:copy-of select="gn-fn-iso19115-3.2018ICSM:fillTextElement($url, $mainLangId, $useOnlyPTFreeText)"/>
            </cit:linkage>
            <cit:protocol>
