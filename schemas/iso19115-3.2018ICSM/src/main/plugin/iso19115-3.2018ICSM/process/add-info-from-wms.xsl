...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:variable name="wms-info-loc">
    ...
    <msg id="b" xml:lang="dut">. Gebruik deze functie om de dekking, de projectie of thumbnail af te leiden of bij te
      werken vanuit deze WMS-service voor de laag met de naam:
    </msg>
          ...
          <srv:SV_OperationMetadata>
            ...
            <srv:connectPoint>
              <cit:CI_OnlineResource>
                <cit:linkage>
                  <gco:CharacterString>
                    <xsl:value-of select="$wmsServiceUrl"/>
                  </gco:CharacterString>
                </cit:linkage>
                <cit:protocol>
                ...
                <cit:name>
                  <gco:CharacterString>
                    <xsl:value-of select="geonet:i18n($wms-info-loc, 'connectPoint', $guiLang)"/>
                  </gco:CharacterString>
                </cit:name>
                <cit:description>
                  <gco:CharacterString>
                    <xsl:value-of select="geonet:i18n($wms-info-loc, 'connectPointDesc', $guiLang)"/>
                  </gco:CharacterString>
                </cit:description>
                <cit:function>
