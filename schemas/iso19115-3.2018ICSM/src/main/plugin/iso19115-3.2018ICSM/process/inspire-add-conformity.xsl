...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
  ...
  <xsl:variable name="inspire-conformity-loc">
    ...
    <msg id="a" xml:lang="fre">thème(s) INSPIRE trouvé(s). Exécuter cette action pour ajouter une section conformité
      INSPIRE.
    </msg>
  </xsl:variable>
  ...
  <xsl:variable name="specificationTitles">
    <eng>
      ...
      <spec theme="Coordinate Reference Systems"
            title="INSPIRE Specification on Coordinate Reference Systems - Guidelines v 3.1" date="2010-05-03"/>
      <spec theme="Geographical Grid Systems"
            title="INSPIRE Specification on Geographical Grid Systems - Guidelines v 3.0.1" date="2010-05-03"/>
      <spec
        title="COMMISSION REGULATION (EU) No 1089/2010 of 23 November 2010 implementing Directive 2007/2/EC of the European Parliament and of the Council as regards interoperability of spatial data sets and services"
        date="2010-12-08"/>
    </eng>
    <fre>
      <spec theme="Administrative Units" title="Guide INSPIRE sur les unités administratives - v3.0.1"
            date="2010-05-03"/>
      <spec theme="Cadastral Parcels" title="Guide INSPIRE sur les parcelles cadastrales - v 3.0.1" date="2010-05-03"/>
      <spec theme="Geographical Names" title="Guide INSPIRE sur les dénominations géographiques - v 3.0.1"
            date="2010-05-03"/>
      ...
      <spec theme="Coordinate Reference Systems" title="Guide INSPIRE sur les référentiels de coordonnées - v 3.1"
            date="2010-05-03"/>
      <spec theme="Geographical Grid Systems" title="Guide INSPIRE sur les systèmes de maillage géographique - v 3.0.1"
            date="2010-05-03"/>
      <spec
