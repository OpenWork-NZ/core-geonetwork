...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- Readonly elements -->
  <xsl:template mode="modeso19115-i-3.2018ICSM"
  ...
  <xsl:template mode="mode-iso19115-3.2018ICSM"
    ...
    <xsl:call-template name="render-boxed-element">
      ...
      <xsl:with-param name="subTreeSnippet">
        ...
        <xsl:apply-templates mode="mode-iso19115-3.2018ICSM"
  ...
  <xsl:template mode="mode-iso19115-3.2018ICSM" priority="2000" match="mri:*[gco:*/@uom]">
    <xsl:param name="schema" select="$schema" required="no"/>
    <xsl:param name="labels" select="$labels" required="no"/>
  ...
  <!-- <xsl:template mode="mode-iso19115-3.2018ICSM"
     ...
     <div class="row">
       <div class="col-md-8">
         <xsl:apply-templates mode="mode-iso19115-3.2018ICSM" select="cit:date">
           <xsl:with-param name="schema" select="$schema"/>
           <xsl:with-param name="labels" select="$labels"/>
         </xsl:apply-templates>
       </div>
       <div class="col-md-4">
         <xsl:apply-templates mode="mode-iso19115-3.2018ICSM" select="cit:dateType">
           <xsl:with-param name="schema" select="$schema"/>
           <xsl:with-param name="labels" select="$labels"/>
         </xsl:apply-templates>
       </div>
  ...
  <xsl:template mode="mode-iso19115-3.2018ICSM" match="gml:beginPosition|gml:endPosition|gml:timePosition"
                priority="200">
    ...
    <xsl:call-template name="render-boxed-element">
      ...
      <xsl:with-param name="subTreeSnippet">
        <div gn-draw-bbox="" data-hleft="{gex:westBoundLongitude/gco:Decimal}"
             ...
             data-htop="{gex:northBoundLatitude/gco:Decimal}"
             data-hleft-ref="_{gex:westBoundLongitude/gco:Decimal/gn:element/@ref}"
  ...
  <xsl:template mode="mode-iso19115-3.2018ICSM"
                match="*[
                        *[1]/name() = $editorConfig/editor/tableFields/table/@for and
                        ...
                        $isFlatMode]"
                priority="2000">
    <xsl:call-template name="iso19115-3.2018ICSM-table"/>
  </xsl:template>
  ...
  <!-- Define table layout -->
  <xsl:template name="iso19115-3.2018ICSM-table">
