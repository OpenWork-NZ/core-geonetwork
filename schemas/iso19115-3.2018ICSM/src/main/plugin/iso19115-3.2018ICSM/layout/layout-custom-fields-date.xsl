...
<xsl:stylesheet version="2.0"
  ...
  -->
  <xsl:template mode="mode-iso19115-3.2018ICSM" match="*[cit:CI_Date]" priority="2000">
  ...
  <xsl:template mode="mode-iso19115-3.2018ICSM" match="cit:dateType" priority="2000"/>
      ...
      <div class="col-sm-3 gn-value">
        ...
        <xsl:call-template name="render-codelist-as-select">
          ...
          <xsl:with-param name="name"
                          select="concat(../cit:dateType/cit:CI_DateTypeCode/gn:element/@ref, '_codeListValue')"/>
        </xsl:call-template>
