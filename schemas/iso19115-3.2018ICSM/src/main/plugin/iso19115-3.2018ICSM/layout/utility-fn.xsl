...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:function name="gn-fn-iso19115-3.2018ICSM:write-date-or-dateTime" as="node()">
  ...
  prefixed by #.
        -->
  <xsl:function name="gn-fn-iso19115-3.2018ICSM:getLangId" as="xs:string">
    <xsl:param name="md"/>
    <xsl:param name="lang"/>
  ...
  <xsl:function name="gn-fn-iso19115-3.2018ICSM:getCodeListType" as="xs:string">
  ...
  <xsl:function name="gn-fn-iso19115-3.2018ICSM:isNotMultilingualField" as="xs:boolean">
  ...
  <!--
    ...
    * split by value separator (usually #) to get each language code and value pair.
    ...
    to get the value.
   -->
  <xsl:function name="gn-fn-iso19115-3.2018ICSM:fillTextElement" as="node()*">
    <xsl:param name="string" as="xs:string"/>
    <xsl:param name="mainLanguage" as="xs:string?"/>
    <xsl:param name="useOnlyPTFreeText" as="xs:boolean"/>

    <xsl:copy-of
      select="gn-fn-iso19115-3.2018ICSM:fillTextElement($string, '\|', '#', $mainLanguage, $useOnlyPTFreeText)"/>
  </xsl:function>
