    ...
    <xsl:template match="/">
        ...
        <xsl:for-each select="//(gmd:MD_Metadata|gmi:MI_Metadata|gfcold:FC_FeatureCatalogue)">
            ...
            <xsl:element name="mdb:MD_Metadata">
                ...
                <xsl:apply-templates select="gmd:fileIdentifier|@uuid" mode="from19139to19115-3.2018GNSS"/>
                ...
                <xsl:apply-templates select="gmd:parentIdentifier" mode="from19139to19115-3.2018GNSS"/>
                <xsl:apply-templates select="gmd:hierarchyLevel" mode="from19139to19115-3.2018GNSS"/>
                <xsl:apply-templates select="gmd:contact" mode="from19139to19115-3.2018GNSS"/>
                ...
                <xsl:apply-templates select="gmd:dateStamp" mode="from19139to19115-3.2018GNSS"/>
                <xsl:apply-templates select="gmd:metadataStandardName" mode="from19139to19115-3.2018GNSS"/>
                ...
                <xsl:apply-templates select="gmd:locale" mode="from19139to19115-3.2018GNSS"/>
                <xsl:apply-templates select="gmd:spatialRepresentationInfo" mode="from19139to19115-3.2018GNSS"/>
                <xsl:apply-templates select="gmd:referenceSystemInfo" mode="from19139to19115-3.2018GNSS"/>
                <xsl:apply-templates select="gmd:metadataExtensionInfo" mode="from19139to19115-3.2018GNSS"/>
                <xsl:apply-templates select="gmd:identificationInfo" mode="from19139to19115-3.2018GNSS"/>
                <xsl:apply-templates select="gmd:contentInfo" mode="from19139to19115-3.2018GNSS"/>
                ...
                <xsl:apply-templates select="gmd:distributionInfo" mode="from19139to19115-3.2018GNSS"/>
                <xsl:apply-templates select="gmd:dataQualityInfo" mode="from19139to19115-3.2018GNSS"/>
                <xsl:apply-templates select="gmd:portrayalCatalogueInfo" mode="from19139to19115-3.2018GNSS"/>
                <xsl:call-template name="onlineSourceDispatcher">
                    <xsl:with-param name="type" select="'portrayalCatalogueCitation'"/>
                </xsl:call-template>

                <xsl:apply-templates select="gmd:metadataConstraints" mode="from19139to19115-3.2018GNSS"/>
                <xsl:apply-templates select="gmd:applicationSchemaInfo" mode="from19139to19115-3.2018GNSS"/>
                <xsl:apply-templates select="gmd:metadataMaintenance" mode="from19139to19115-3.2018GNSS"/>
                <xsl:apply-templates select="gmi:acquisitionInformation" mode="from19139to19115-3.2018GNSS"/>
            </xsl:element>
        </xsl:for-each>
    </xsl:template>
