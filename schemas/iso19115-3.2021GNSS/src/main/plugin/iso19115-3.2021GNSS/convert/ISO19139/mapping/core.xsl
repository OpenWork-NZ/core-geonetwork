<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  ...
  xmlns:srv="http://standards.iso.org/iso/19115/-3/srv/2.1" xmlns:mac="http://standards.iso.org/iso/19115/-3/mac/2.0" xmlns:mas="http://standards.iso.org/iso/19115/-3/mas/1.0"
  ...
  -->
  <xsl:template match="gmd:fileIdentifier" priority="5" mode="from19139to19115-3.2018GNSS">
    <!--
  ...
  <xsl:template match="gfcold:FC_FeatureCatalogue/@uuid" priority="5" mode="from19139to19115-3.2018GNSS">
    <xsl:element name="mdb:metadataIdentifier">
      <mcc:MD_Identifier>
        <mcc:code>
  ...
  <xsl:template match="gfcold:typeName/gcoold:LocalName
                ...
                mode="from19139to19115-3.2018GNSS">
    <xsl:value-of select="."/>
  </xsl:template>


  <xsl:template match="gmd:language|gmd:locale" priority="5" mode="from19139to19115-3.2018GNSS">
    <xsl:variable name="nameSpacePrefix">
      <xsl:call-template name="getNamespacePrefix"/>
    </xsl:variable>
  ...
  <xsl:template match="gmd:characterSet" priority="5" mode="from19139to19115-3.2018GNSS">
    <xsl:choose>
  ...
  <xsl:template match="gmd:parentIdentifier" priority="5" mode="from19139to19115-3.2018GNSS">
    <!--
  ...
  <xsl:template match="gmd:hierarchyLevel" priority="5" mode="from19139to19115-3.2018GNSS">
    <!-- ************************************************************************ -->
  ...
  <xsl:template match="gmd:dateStamp" priority="5" mode="from19139to19115-3.2018GNSS">
    <!--
  ...
  <xsl:template match="gmi:geographicCoordinates" mode="from19139to19115-3.2018GNSS">
    <xsl:choose>
  ...
  <xsl:template match="gmd:MD_PixelOrientationCode" mode="from19139to19115-3.2018GNSS">
  ...
  <xsl:template match="gmd:identificationInfo" mode="from19139to19115-3.2018GNSS">
    <mdb:identificationInfo>
      ...
      <xsl:for-each select="./*">
        ...
        <xsl:element name="{concat($nameSpacePrefix,':',local-name(.))}">
          <xsl:apply-templates select="@*" mode="from19139to19115-3.2018GNSS"/>
          <xsl:apply-templates select="gmd:citation" mode="from19139to19115-3.2018GNSS"/>
          <xsl:call-template name="writeCharacterStringElement">
          ...
          <xsl:apply-templates select="gmd:credit" mode="from19139to19115-3.2018GNSS"/>
          <xsl:call-template name="writeCodelistElement">
          ...
          <xsl:apply-templates select="gmd:pointOfContact" mode="from19139to19115-3.2018GNSS"/>
            <xsl:call-template name="writeCodelistElement">
          ...
          <xsl:apply-templates select="gmd:spatialResolution" mode="from19139to19115-3.2018GNSS"/>
          <!-- This is here to handle early adopters of temporalResolution -->
          <xsl:apply-templates select="gmd:temporalResolution" mode="from19139to19115-3.2018GNSS"/>
          <xsl:apply-templates select="gmd:topicCategory" mode="from19139to19115-3.2018GNSS"/>
          <xsl:apply-templates select="gmd:extent | srvold:extent" mode="from19139to19115-3.2018GNSS"/>
          <xsl:apply-templates select="gmd:resourceMaintenance" mode="from19139to19115-3.2018GNSS"/>
          <xsl:apply-templates select="gmd:graphicOverview" mode="from19139to19115-3.2018GNSS"/>
          <xsl:apply-templates select="gmd:resourceFormat" mode="from19139to19115-3.2018GNSS"/>
          <xsl:apply-templates select="gmd:descriptiveKeywords" mode="from19139to19115-3.2018GNSS"/>
          <xsl:apply-templates select="gmd:resourceSpecificUsage" mode="from19139to19115-3.2018GNSS"/>
          <xsl:apply-templates select="gmd:resourceConstraints" mode="from19139to19115-3.2018GNSS"/>
          <xsl:apply-templates select="gmd:aggregationInfo" mode="from19139to19115-3.2018GNSS"/>
          <xsl:call-template name="collectiveTitle"/>
          <xsl:apply-templates select="gmd:language" mode="from19139to19115-3.2018GNSS"/>
          <xsl:apply-templates select="gmd:characterSet" mode="from19139to19115-3.2018GNSS"/>
          <xsl:call-template name="writeCharacterStringElement">
          ...
          <xsl:if test="local-name()='SV_ServiceIdentification'">
            ...
            <xsl:apply-templates select="srvold:containsOperations" mode="from19139to19115-3.2018GNSS"/>
            <xsl:apply-templates select="srvold:operatesOn" mode="from19139to19115-3.2018GNSS"/>
          </xsl:if>
        </xsl:element>
      </xsl:for-each>
    </mdb:identificationInfo>
  ...
  <xsl:template match="gmd:contentInfo[not(gmd:MD_FeatureCatalogueDescription) and
                                           not(gmd:MD_ImageDescription)]" mode="from19139to19115-3.2018GNSS">
            ...
            <xsl:for-each select="//gmd:contentInfo/gmd:MD_CoverageDescription | //gmd:contentInfo/gmi:MI_CoverageDescription">
              <xsl:element name="mrc:attributeGroup">
                <xsl:element name="mrc:MD_AttributeGroup">
                  <xsl:apply-templates mode="from19139to19115-3.2018GNSS"/>
                </xsl:element>
              </xsl:element>
            </xsl:for-each>
  ...
  <xsl:template match="gmd:contentInfo[gmd:MD_FeatureCatalogueDescription] | gmd:contentInfo[gmd:MD_ImageDescription]" mode="from19139to19115-3.2018GNSS">
    <xsl:element name="mdb:contentInfo">
      <xsl:apply-templates mode="from19139to19115-3.2018GNSS"/>
    </xsl:element>
  </xsl:template>
  <xsl:template match="//gmd:MD_FeatureCatalogueDescription/gmd:featureTypes" mode="from19139to19115-3.2018GNSS">
    <mrc:featureTypes>
  ...
  <xsl:template match="gmi:acquisitionInformation" mode="from19139to19115-3.2018GNSS">
    <xsl:element name="mdb:acquisitionInformation">
      <xsl:element name="mac:MI_AcquisitionInformation">
        <xsl:apply-templates select="gmi:MI_AcquisitionInformation/gmi:instrument" mode="from19139to19115-3.2018GNSS"/>
        <xsl:apply-templates select="gmi:MI_AcquisitionInformation/gmi:operation" mode="from19139to19115-3.2018GNSS"/>
        <xsl:apply-templates select="gmi:MI_AcquisitionInformation/gmi:platform" mode="from19139to19115-3.2018GNSS"/>
        <xsl:apply-templates select="gmi:MI_AcquisitionInformation/gmi:acquisitionPlan" mode="from19139to19115-3.2018GNSS"/>
        <xsl:apply-templates select="gmi:MI_AcquisitionInformation/gmi:objective" mode="from19139to19115-3.2018GNSS"/>
        <xsl:apply-templates select="gmi:MI_AcquisitionInformation/gmi:acquisitionRequirement" mode="from19139to19115-3.2018GNSS"/>
      </xsl:element>
    </xsl:element>
  </xsl:template>
  <xsl:template match="gmi:objectiveOccurance" mode="from19139to19115-3.2018GNSS">
  ...
  -->
  <xsl:template match="gmi:geolocationInformation/gmi:MI_GCPCollection" mode="from19139to19115-3.2018GNSS">
    <xsl:element name="msr:MI_GCPCollection">
      <xsl:apply-templates select="gmi:gcp" mode="from19139to19115-3.2018GNSS"/>
      <xsl:apply-templates select="gmi:collectionIdentification" mode="from19139to19115-3.2018GNSS"/>
      <xsl:apply-templates select="gmi:collectionName" mode="from19139to19115-3.2018GNSS"/>
      <xsl:apply-templates select="gmi:coordinateReferenceSystem" mode="from19139to19115-3.2018GNSS"/>
    </xsl:element>
  </xsl:template>
  <!--
  gmd:identificationInformation templates
  -->
  <xsl:template match="/*/gmd:identificationInfo/*/gmd:citation/gmd:CI_Citation/gmd:citedResponsibleParty" mode="from19139to19115-3.2018GNSS">
  ...
  <xsl:template match="/*/gmd:identificationInfo/*/gmd:resourceSpecificUsage/gmd:MD_Usage/gmd:usageDateTime" mode="from19139to19115-3.2018GNSS">
    <mri:usageDateTime>
      <gml:TimeInstant>
        <xsl:attribute name="gml:id">
          <xsl:value-of select="generate-id()"/>
  ...
  <xsl:template match="gmd:aggregationInfo" priority="5" mode="from19139to19115-3.2018GNSS">
    <!--
        ...
        <xsl:if test="not($associatedResourceAsMetadataReferenceOnly)">
          <xsl:choose>
            <xsl:when test="exists(gmd:MD_AggregateInformation/gmd:aggregateDataSetName)
              ...
              <mri:name>
                <xsl:apply-templates select="gmd:MD_AggregateInformation/gmd:aggregateDataSetName/gmd:CI_Citation" mode="from19139to19115-3.2018GNSS"/>
              </mri:name>
            </xsl:when>
            <xsl:when test="exists(gmd:MD_AggregateInformation/gmd:aggregateDataSetName)">
            ...
            <xsl:when test="exists(gmd:MD_AggregateInformation/gmd:aggregateDataSetIdentifier)">
              ...
              <mri:name>
                <cit:CI_Citation>
                  ...
                  <cit:identifier>
                    <xsl:apply-templates select="gmd:MD_AggregateInformation/gmd:aggregateDataSetIdentifier/gmd:MD_Identifier" mode="from19139to19115-3.2018GNSS"/>
                  </cit:identifier>
                </cit:CI_Citation>
              </mri:name>
            </xsl:when>
  ...
  <xsl:template match="gmd:aggregationInfo/gmd:MD_AggregateInformation/gmd:aggregateDataSetName/gmd:CI_Citation/gmd:citedResponsibleParty" mode="from19139to19115-3.2018GNSS">
    <xsl:if test="not(preceding-sibling::gmd:citedResponsibleParty) and ancestor::gmd:MD_AggregateInformation/gmd:aggregateDataSetIdentifier">
      ...
      ********************************************************************** -->
      <cit:identifier>
        <xsl:apply-templates select="ancestor::gmd:MD_AggregateInformation/gmd:aggregateDataSetIdentifier/gmd:MD_Identifier" mode="from19139to19115-3.2018GNSS"/>
      </cit:identifier>
    </xsl:if>
    <cit:citedResponsibleParty>
      <xsl:apply-templates mode="from19139to19115-3.2018GNSS"/>
  ...
  -->
  <xsl:template match="gmd:RS_Identifier" mode="from19139to19115-3.2018GNSS">
    <mcc:MD_Identifier>
      <xsl:apply-templates select="@*" mode="from19139to19115-3.2018GNSS"/>
      <xsl:apply-templates mode="from19139to19115-3.2018GNSS"/>
    </mcc:MD_Identifier>
  ...
  <!--
    gmd:contentInfo
  -->
  <xsl:template match="gmd:dimension" mode="from19139to19115-3.2018GNSS">
    <xsl:element name="mrc:attribute">
      <xsl:apply-templates mode="from19139to19115-3.2018GNSS"/>
    </xsl:element>
  </xsl:template>
  <xsl:template match="gmd:MD_Band" mode="from19139to19115-3.2018GNSS">
    <xsl:element name="mrc:MD_SampleDimension">
      <xsl:apply-templates mode="from19139to19115-3.2018GNSS"/>
    </xsl:element>
  </xsl:template>
  <xsl:template match="gmi:MI_Band" mode="from19139to19115-3.2018GNSS">
  ...
  <xsl:template match="gmd:MD_Band/gmd:descriptor|
                       ...
                       gmd:MD_RangeDimension/gmd:descriptor" mode="from19139to19115-3.2018GNSS">
  ...
  -->
  <xsl:template match="gmd:MD_DigitalTransferOptions/gmd:offLine/gmd:MD_Medium/gmd:name" mode="from19139to19115-3.2018GNSS">
    <mrd:name>
      <cit:CI_Citation>
        <cit:title>
          <gco:CharacterString>
  ...
  -->
  <xsl:template match="gmd:MD_MaintenanceInformation/gmd:dateOfNextUpdate" mode="from19139to19115-3.2018GNSS">
    <mmi:maintenanceDate>
      <cit:CI_Date>
        <cit:date>
          <xsl:call-template name="writeDateTime"/>
  ...
  -->
  <xsl:template match="gmi:MI_Operation/gmi:status/gmd:MD_ProgressCode" mode="from19139to19115-3.2018GNSS">
  ...
  -->
  <xsl:template match="gmd:hierarchyLevelName" priority="5" mode="from19139to19115-3.2018GNSS"/>
  <xsl:template match="gmd:metadataStandardVersion" priority="5" mode="from19139to19115-3.2018GNSS"/>
  <xsl:template match="gmd:dataSetURI" priority="5" mode="from19139to19115-3.2018GNSS"/>
  <!-- Match MD_ and MI_CoverageDescription -->
  <xsl:template match="gmd:contentInfo/gmd:MD_CoverageDescription/gmd:attributeDescription | gmd:contentInfo/gmi:MI_CoverageDescription/gmd:attributeDescription" priority="5" mode="from19139to19115-3.2018GNSS"/>
  <xsl:template match="gmd:contentInfo/gmi:MI_CoverageDescription/gmi:rangeElementDescription" priority="5" mode="from19139to19115-3.2018GNSS"/>
  <xsl:template match="gmd:contentInfo/gmd:MD_ImageDescription/gmd:contentType" priority="5" mode="from19139to19115-3.2018GNSS"/>
  <xsl:template match="gmd:MD_ExtendedElementInformation/gmd:shortName" priority="5" mode="from19139to19115-3.2018GNSS"/>
  <xsl:template match="gmd:MD_ExtendedElementInformation/gmd:domainCode" priority="5" mode="from19139to19115-3.2018GNSS"/>
  <xsl:template match="gmd:MD_Format/gmd:name" priority="5" mode="from19139to19115-3.2018GNSS"/>
  <xsl:template match="gmd:MD_Format/gmd:specification" priority="5" mode="from19139to19115-3.2018GNSS"/>
  <xsl:template match="gmd:MD_Format/gmd:version" priority="5" mode="from19139to19115-3.2018GNSS"/>
</xsl:stylesheet>
