...
<xsl:stylesheet version="2.0"
  ...
  <xsl:template name="to-iso19115-3.2018GNSS-keyword-with-anchor">
    <xsl:call-template name="to-iso19115-3.2018GNSS-keyword">
      <xsl:with-param name="withAnchor" select="true()"/>
    </xsl:call-template>
  </xsl:template>


  <!-- Convert a concept to an iso19115-3.2018GNSS mri:MD_Keywords with an
       XLink which will be resolved by XLink resolver. -->
  <xsl:template name="to-iso19115-3.2018GNSS-keyword-as-xlink">
    <xsl:call-template name="to-iso19115-3.2018GNSS-keyword">
  ...
  <!-- Convert a concept to an iso19115-3.2018GNSS keywords.
    If no keyword is provided, only thesaurus section is adaded.
    -->
  <xsl:template name="to-iso19115-3.2018GNSS-keyword">
    ...
    <xsl:apply-templates mode="to-iso19115-3.2018GNSS-keyword" select="." >
  ...
  <xsl:template mode="to-iso19115-3.2018GNSS-keyword"
    ...
    <mri:descriptiveKeywords>
      <xsl:choose>
        ...
        <xsl:otherwise>
          <xsl:call-template name="to-iso19115-3.2018GNSS-md-keywords">
            <xsl:with-param name="withAnchor" select="$withAnchor"/>
            <xsl:with-param name="withThesaurusAnchor" select="$withThesaurusAnchor"/>
            <xsl:with-param name="listOfLanguage" select="$listOfLanguage"/>
            <xsl:with-param name="textgroupOnly" select="$textgroupOnly"/>
  ...
  <xsl:template mode="to-iso19115-3.2018GNSS-keyword" match="*[/root/request/skipdescriptivekeywords]">
    <xsl:param name="textgroupOnly"/>
    <xsl:param name="listOfLanguage"/>
    <xsl:param name="withAnchor"/>
    <xsl:param name="withThesaurusAnchor"/>
  ...
  <xsl:template name="to-iso19115-3.2018GNSS-md-keywords">
    <xsl:param name="textgroupOnly"/>
    <xsl:param name="listOfLanguage"/>
    <xsl:param name="withAnchor"/>
    <xsl:param name="withThesaurusAnchor"/>
    <mri:MD_Keywords>
      ...
      <xsl:copy-of select="geonet:add-iso19115-3.2018GNSS-thesaurus-info(
  ...
  <xsl:function name="geonet:add-iso19115-3.2018GNSS-thesaurus-info">
  ...
  <!-- Convert a concept to an iso19115-3.2018GNSS extent -->
  <xsl:template name="to-iso19115-3.2018GNSS-extent">
