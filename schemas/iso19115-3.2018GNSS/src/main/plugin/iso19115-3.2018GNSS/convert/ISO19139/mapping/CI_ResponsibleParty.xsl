...
<xsl:stylesheet version="2.0"
    ...
    <xsl:template match="gmd:CI_ResponsibleParty" mode="from19139to19115-3.2018GNSS">
        <xsl:choose>
                   ...
                   <xsl:apply-templates select="./@*" mode="from19139to19115-3.2018GNSS"/>
                    <xsl:choose>
                        ...
                        <xsl:when test="./gmd:role/@*">
                            <cit:role>
                                <xsl:apply-templates select="./gmd:role/@*" mode="from19139to19115-3.2018GNSS"/>
                            </cit:role>
                        </xsl:when>
                        <xsl:otherwise>
    ...
    -->
        <xsl:apply-templates select=".//gmd:onlineResource" mode="from19139to19115-3.2018GNSS"/>
    </xsl:template>

    <xsl:template match="gmd:contactInfo/gmd:CI_Contact/gmd:phone" mode="from19139to19115-3.2018GNSS">
    ...
    <xsl:template match="gmd:CI_ResponsibleParty/gmd:role" priority="5" mode="from19139to19115-3.2018GNSS"/>
    <xsl:template match="gmd:CI_ResponsibleParty/gmd:organisationName" priority="5" mode="from19139to19115-3.2018GNSS"/>
    <xsl:template match="gmd:CI_ResponsibleParty/gmd:individualName" priority="5" mode="from19139to19115-3.2018GNSS"/>
    <xsl:template match="gmd:CI_ResponsibleParty/gmd:positionName" priority="5" mode="from19139to19115-3.2018GNSS"/>
