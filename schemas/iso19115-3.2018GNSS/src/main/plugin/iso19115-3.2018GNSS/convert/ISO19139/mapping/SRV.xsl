<xsl:stylesheet version="2.0"
  ...
  <xsl:template match="srvold:optionality" mode="from19139to19115-3.2018GNSS">
    <srv:optionality>
      <gco:Boolean>
  ...
  <xsl:template match="srvold:containsOperations" mode="from19139to19115-3.2018GNSS">
    <srv:containsOperations>
      <srv:SV_OperationMetadata>
        ...
        <xsl:apply-templates select="srvold:SV_OperationMetadata/srvold:connectPoint" mode="from19139to19115-3.2018GNSS"/>
        <xsl:apply-templates select="srvold:SV_OperationMetadata/srvold:parameters" mode="from19139to19115-3.2018GNSS"/>
      </srv:SV_OperationMetadata>
    </srv:containsOperations>
  </xsl:template>

  <xsl:template match="srvold:parameters" mode="from19139to19115-3.2018GNSS">
    <srv:parameter>
      <xsl:apply-templates select="srvold:SV_Parameter" mode="from19139to19115-3.2018GNSS"/>
    </srv:parameter>
  </xsl:template>

  <xsl:template match="srvold:SV_Parameter/srvold:name" mode="from19139to19115-3.2018GNSS">
  ...
  <xsl:template match="srvold:containsOperations/srvold:SV_OperationMetadata/srvold:parameters/srvold:SV_Parameter/srvold:valueType" priority="5" mode="from19139to19115-3.2018GNSS"/>
