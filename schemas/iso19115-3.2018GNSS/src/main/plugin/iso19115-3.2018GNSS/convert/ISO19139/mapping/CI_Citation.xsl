<xsl:stylesheet version="2.0"
    ...
    <xsl:template match="gmd:CI_Citation" mode="from19139to19115-3.2018GNSS">
    ...
    <xsl:template match="gmd:CI_Citation/gmd:date" mode="from19139to19115-3.2018GNSS">
        <cit:date>
    ...
    <xsl:template match="gmd:CI_Citation/gmd:title" mode="from19139to19115-3.2018GNSS">
    ...
    <xsl:template match="gmd:CI_Citation/gmd:editionDate" mode="from19139to19115-3.2018GNSS">
        <cit:editionDate>
            <xsl:call-template name="writeDateTime"/>
        </cit:editionDate>
    </xsl:template>
    ...
    <xsl:template match="gmd:CI_Citation/gmd:collectiveTitle" mode="from19139to19115-3.2018GNSS"/>
</xsl:stylesheet>
